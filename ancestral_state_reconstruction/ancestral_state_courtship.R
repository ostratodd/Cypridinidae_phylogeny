...
lum_data <- read.table("character_matrix_luminescence_edited_courtship.tab",stringsAsFactors=FALSE)
...
# Phylogeny plot full
setEPS()
postscript("ASR_ER_cypridindae_astral_courtship.eps")
...
# Phylogeny plot full
setEPS()
postscript("ASR_ER_cypridindae_concat_courtship.eps")
